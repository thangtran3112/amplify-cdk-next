import { DynamoDBScanRequest, DynamoDBQueryRequest, DynamoDBPutItemRequest, DynamoDBSyncRequest, DynamoDBDeleteItemRequest, DynamoDBUpdateItemRequest, DynamoDBGetItemRequest } from '@aws-appsync/utils/lib/resolver-return-types';
import { DynamoDBFilterObject, DynamoDBEqualityOperators } from '@aws-appsync/utils/lib/transform-utils';
import { Decrement, Prettify } from '@aws-appsync/utils/lib/type-utils';
