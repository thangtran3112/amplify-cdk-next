...
import { CommonTaskDefinitionAttributes, CommonTaskDefinitionProps, ITaskDefinition, NetworkMode, TaskDefinition } from 'aws-cdk-lib/aws-ecs/lib/base/task-definition';
